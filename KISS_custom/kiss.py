...
import utils_kiss
from exp3_cell_onoff_scenario import EXP3CellOnOff
...
def main(config_dict):
    ...
    # EXP3 cell on/off scenario
    exp3_cell_onoff = EXP3CellOnOff(
        sim,
        k_cells=config_dict.get("exp3_k_cells", None),  # None means all cells
        ...
        output_dir=data_output_logfile_path,  # Use same directory as logs
        delay=scenario_delay
    )
